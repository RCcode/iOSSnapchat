...
- (void)corner:(CornerView *)corner TouchesMoved:(UITouch *)touch{
    ...
    CGPoint touchMovePoint = [touch locationInView:corner.superview];
    CGPoint touchMovePrePoint = [touch previousLocationInView:corner.superview];
...
//    }
    else if (self.style == kAspectRatio4_3)
    {
        //4:3
        offset = CGSizeMake((touchMovePoint.x - touchMovePrePoint.x),
                            (touchMovePoint.x - touchMovePrePoint.x)*3/4);
    }
    else if (self.style == kAspectRatio3_4)
    {
        //3:4
        offset = CGSizeMake((touchMovePoint.x - touchMovePrePoint.x),
                            (touchMovePoint.x - touchMovePrePoint.x)*4/3);
    }
    else if (self.style == kAspectRatio16_9)
    {
        //16:9
        offset = CGSizeMake((touchMovePoint.x - touchMovePrePoint.x),
                            (touchMovePoint.x - touchMovePrePoint.x)*9/16);
    }
    else if (self.style == kAspectRatio9_16)
    {
        //9:16
        offset = CGSizeMake((touchMovePoint.x - touchMovePrePoint.x),
