...
- (void)setupChildViews{
    ...
    if (_cameraAperture == nil) {
        _cameraAperture = [[CameraApertureView alloc] initWithFrame:CGRectMake(0, (kRCScreenHeight - 64 - kRCScreenWidth) * 0.5, kRCScreenWidth, kRCScreenWidth)];
...
//            _cameraAperture.style = CropStyleSquareness3_4;
        }
            break;
...
//            _cameraAperture.style = CropStyleSquareness4_3;
        }
            break;
...
//            _cameraAperture.style = CropStyleSquareness9_16;
...
//            _cameraAperture.style = CropStyleSquareness16_9;
